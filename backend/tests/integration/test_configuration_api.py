...
def test_project_crud_preflight_and_etag__is_persistent(tmp_path: Path, monkeypatch):
    with _client(tmp_path, monkeypatch) as client:
        ...
        project = {"id": "demo", "name": "Demo", "modificationSource": {"type": "git", "repositoryRef": "repo", "executableRef": "git-cli"}, "verification": {"steps": [], "allowNoAutomatedTests": True, "reason": "fixture uses deterministic review"}, "finalActions": [{"id": "patch", "type": "patch", "outputDirectoryRef": "patches"}]}
