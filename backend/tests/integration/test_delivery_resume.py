...
def _config(tmp_path: Path) -> tuple[Path, dict[str, object]]:
    config_path=tmp_path/"config/defaults/codefixer.json";config_path.parent.mkdir(parents=True);project={"id":"demo","name":"Demo","deliveryLog":{"technologyTag":"Python","branchLabel":"main","versionSource":"fixed","versionFallback":"v1","submitterName":"Tester"},"finalActions":[{"id":"primary-patch","type":"patch","outputDirectory":str((tmp_path/"data/patches").resolve())}]}
