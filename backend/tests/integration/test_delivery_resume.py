...
def test_frozen_patch_delivery_resumes_after_restart_without_duplicate_output(tmp_path: Path):
    ...
    with connect_database(loaded.data_root/"codefixer.db") as connection:
        ...
        manifest={"schema_version":1,"change_version":1,"modification_source":{"id":"source","base_revision":"abc123"},"diff":{"path":"change.patch","sha256":patch_sha},"files":[{"path":"app.txt","operation":"modify","content_sha256":"0"*64}],"source_commits":[],"verification_sha256":"1"*64,"coding_result_sha256":"2"*64,"config_sha256":"3"*64};(freeze_root/"change-manifest.json").write_text(json.dumps(manifest),encoding="utf-8")
