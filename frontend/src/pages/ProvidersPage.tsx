...
export function ProvidersPage() {
  ...
  return <section className="page-stack providers-page">
    <div className="page-heading"><div><span className="page-kicker">INTAKE CHANNELS</span><h1>工单来源</h1><p>连接问题反馈平台；登录信息只保存在当前部署机的 .local 中。</p></div><button className="primary compact" onClick={openNew}>添加来源</button></div>
